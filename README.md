...
### Features:
---
- Searching country information
- Interactive world map
- Login & Register, and user account management
- Integration with external and internal APIs
- Safety categories and related recommendations
- Points of interest and recommendations
- News and AI travel planner (not yet integrated)
